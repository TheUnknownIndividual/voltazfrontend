          ...
          <div>
            ...
            <ul className="space-y-4 text-sm font-medium">
              ...
              <li className="flex items-center gap-4">
                ...
                <a href="https://wa.me/994504180001" target="_blank" rel="noopener noreferrer" className="text-slate-500 hover:text-emerald-600 transition-colors">+994 50 418 00 01</a>
              </li>
              <li className="flex items-center gap-4">
                ...
                <a href="mailto:info@volt.az" className="text-slate-500 hover:text-emerald-600 transition-colors">info@volt.az</a>
              </li>
            </ul>
          </div>
        </div>
