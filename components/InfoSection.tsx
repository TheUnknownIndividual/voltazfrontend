...
import { ArrowRight, BookOpen, Calculator, Check, CloudSun, House, Info, Plug, Share2, Sun, Wrench } from 'lucide-react';
...
const copy = {
  az: {
    ...
    consumerPackageLabel: 'Paketi',
    consumerIncludedLabel: 'Paketə daxildir',
    consumerInverterLabel: 'İnverter',
    consumerMountingLabel: 'Montaj konstruksiyası',
    consumerGridLabel: 'Şəbəkəyə qoşulma',
  ...
  en: {
    ...
    consumerPackageLabel: 'Package',
    consumerIncludedLabel: 'Included in the package',
    consumerInverterLabel: 'Inverter',
    consumerMountingLabel: 'Mounting structure',
    consumerGridLabel: 'Grid connection',
  ...
  ru: {
    ...
    consumerPackageLabel: 'Пакет',
    consumerIncludedLabel: 'В пакет входит',
    consumerInverterLabel: 'Инвертор',
    consumerMountingLabel: 'Монтажная конструкция',
    consumerGridLabel: 'Подключение к сети',
  ...
  tr: {
    ...
    consumerPackageLabel: 'Paketi',
    consumerIncludedLabel: 'Pakete dahil',
    consumerInverterLabel: 'İnverter',
    consumerMountingLabel: 'Montaj konstrüksiyonu',
    consumerGridLabel: 'Şebeke bağlantısı',
            ...
            <ul className="mt-6 grid items-stretch gap-4 text-left sm:grid-cols-3 md:mt-8">
              {installationPackages.map(pkg => {
                ...
                >
                  ...
                  <span className="text-[9px] font-black uppercase tracking-[0.18em] text-slate-500">{t.consumerPackageLabel}</span>
                  ...
                  <p className="mb-3 mt-4 text-[9px] font-black uppercase tracking-[0.16em] text-slate-500">{t.consumerIncludedLabel}</p>
                  <ul className="space-y-2.5 text-xs leading-5 text-slate-600">
                    <li className="flex gap-2.5">
                      ...
                      {t.consumerPanelLabel(pkg.panelCount, pkg.panelWattage)}
                    </li>
                    <li className="flex gap-2.5">
                      <span className="mt-0.5 flex h-4 w-4 flex-none items-center justify-center rounded-md bg-[var(--color-primary)] text-white"><Check className="h-2.5 w-2.5" strokeWidth={3} aria-hidden="true" /></span>
                      <span className="min-w-0">
                        <span className="block text-[9px] font-black uppercase tracking-wide text-slate-500">{t.consumerInverterLabel}</span>
