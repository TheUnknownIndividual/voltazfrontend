            ...
            <div className="flex flex-col gap-2">
              {hasStock ? (
                <button
                  ...
                  className="flex w-full min-h-[var(--cta-btn-h)] items-center justify-center rounded-xl bg-[var(--primary)] py-3 text-xs font-bold uppercase tracking-[0.04em] text-white transition-colors hover:bg-[var(--primary-hover)] md:py-4"
                >
                ...
                <OutOfStockWhatsappAction
                  ...
                  className="flex w-full min-h-[var(--cta-btn-h)] items-center justify-center rounded-xl bg-[var(--primary)] py-3 text-center text-xs font-bold uppercase tracking-[0.04em] text-white transition-colors hover:bg-[var(--primary-hover)] md:py-4"
                >
                  {t.check}
                </OutOfStockWhatsappAction>
              )}
              <button
                ...
                className="flex w-full min-h-[var(--cta-btn-h)] items-center justify-center rounded-xl border-2 border-[var(--primary)] bg-white py-3 text-xs font-bold uppercase tracking-[0.04em] text-[var(--primary)] transition-colors hover:bg-[var(--primary)] hover:text-white disabled:cursor-not-allowed disabled:border-[var(--border-light)] disabled:bg-slate-100 disabled:text-slate-400 md:py-4"
              >
                {t.addToCart}
              </button>
            </div>
